// app.js - Main application with IntentionAnalyzer integration and word counter
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Word counter - update in real-time
    intentionInput.addEventListener('input', function() {
        ...
        // Show warning and disable button if over 50 words
        if (wordCount > 50) {
